...
case class cardsRepresentAbility()(implicit val rq: Request[model.RootObject])
        extends Brick with CirceJsonapiSupport with parseToken {

    override val brick_name: String = "find cards with represent ability"
    ...
    override def exec: Unit = {
        ...
        card_lst = report.rep_ability_report("overview").map(_.asInstanceOf[Map[String, Any]]).map{ x =>
