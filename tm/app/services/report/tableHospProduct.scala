...
case class tableHospProduct()(implicit val rq: Request[model.RootObject])
    ...
    override def exec: Unit = {
        ...
        table_data.columnsValue = report.dests_goods_report("value").map(_.asInstanceOf[Map[String, Any]])
    }
