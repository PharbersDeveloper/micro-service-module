...
case class cardsRepresentProduct()(implicit val rq: Request[model.RootObject])
        extends Brick with CirceJsonapiSupport with parseToken {

    override val brick_name: String = "find cards with represent product"
    ...
    override def exec: Unit = {
        ...
        card_lst = report.rep_goods_report("overview").map(_.asInstanceOf[Map[String, Any]]).map{ x =>
