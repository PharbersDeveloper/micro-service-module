...
case class tableIndex()(implicit val rq: Request[model.RootObject])
        extends Brick with CirceJsonapiSupport with parseToken {

    override val brick_name: String = "find table with index"
    ...
    override def exec: Unit = {
        ...
        table_data.columns = List(
            ...
            Map("label" -> "市场销售额", "valuePath" -> "potential", "align" -> "center", "cellComponent" -> "table-number-thousands"),
        ...
        table_data.columnsValue = report.summary_report("value").map(_.asInstanceOf[Map[String, Any]])
    }
