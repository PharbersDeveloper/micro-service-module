...
case class cardsResource()(implicit val rq: Request[model.RootObject])
        extends Brick with CirceJsonapiSupport with parseToken {

    override val brick_name: String = "find cards with resource"
    ...
    override def exec: Unit = {
        ...
        card_lst = report.reso_allocation_report("overview").map(_.asInstanceOf[Map[String, Any]]).map{ x =>
