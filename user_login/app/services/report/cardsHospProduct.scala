...
case class cardsHospProduct()(implicit val rq: Request[model.RootObject])
        extends Brick with CirceJsonapiSupport with parseToken {

    override val brick_name: String = "find cards with hosp product"
    ...
    override def exec: Unit = {
        ...
        card_lst = report.dests_goods_report("overview").map(_.asInstanceOf[Map[String, Any]]).map{ x =>
