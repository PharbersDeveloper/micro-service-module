...
case class cardsRepresentTarget()(implicit val rq: Request[model.RootObject])
        extends Brick with CirceJsonapiSupport with parseToken {

    override val brick_name: String = "find cards with represent target"
    ...
    override def exec: Unit = {
        ...
        card_lst = report.rep_ind_resos("overview").map(_.asInstanceOf[Map[String, Any]]).map{ x =>
